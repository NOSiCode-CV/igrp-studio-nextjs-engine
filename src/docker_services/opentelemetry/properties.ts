...
export function opentelemetryProperties() {
  return {
    type: "object",
    properties: {
      image: { type: "string", required: true, default: "otel/opentelemetry-collector-contrib:0.82.0" },
      ...
      volumes: {
        ...
        items: {
          type: "object",
          properties: {
            name: { type: "string", required: true, default: "./monitoring/collector/otel-collector.yml" },
