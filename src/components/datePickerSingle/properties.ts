...
export function datePickerSingleProperties() {
  return {
    ...
    today: { type: 'date', required: false, default: '2025-01-01', 'x-ui-widget': 'date' },
    ...
    defaultMonth: { type: 'date', required: false, default: '2025-01-01', 'x-ui-widget': 'date' },
    startMonth: { type: 'date', required: false, default: '2025-01-01', 'x-ui-widget': 'date' },
    month: { type: 'date', required: false, default: '2025-01-01', 'x-ui-widget': 'date' },
    endMonth: { type: 'date', required: false, default: '2025-12-31', 'x-ui-widget': 'date' },
