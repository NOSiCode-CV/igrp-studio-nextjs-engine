...
export const TEMPLATES = {
  ...
  DEFAULT_DOCKER_SERVICE: 'docker_service/default/default.hbs',
  DOCKER_SERVICE: 'docker_service/{{name}}/{{name}}.hbs',
  ...
  UNREGISTERED_SERVICE: 'docker_service/default/unregisteredService.hbs',
